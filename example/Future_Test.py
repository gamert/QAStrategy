...
if __name__ == '__main__':
    ...
    # QAQueryAdv.QA_fetch_future_min_adv

    strategy = Future_IC2009(code='ICL8', frequence='day',
                   strategy_id='a3916de0-bx8-4b19c-bxxax1-94d91f1744ad', start='2020-08-01', end='2020-08-30')
