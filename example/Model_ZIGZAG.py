...
# 通达信zig函数
# ref2: https://blog.csdn.net/weixin_39594103/article/details/110971545?utm_medium=distribute.pc_relevant_t0.none-task-blog-BlogCommendFromMachineLearnPai2-1.control&dist_request_id=&depth_1-utm_source=distribute.pc_relevant_t0.none-task-blog-BlogCommendFromMachineLearnPai2-1.control
...
def zig(x=0.055):
    ...
    # 通过flag标记，获取对应的波峰波谷值..
    # ref: https://blog.csdn.net/weixin_39594103/article/details/110971545?utm_medium=distribute.pc_relevant_t0.none-task-blog-BlogCommendFromMachineLearnPai2-1.control&dist_request_id=&depth_1-utm_source=distribute.pc_relevant_t0.none-task-blog-BlogCommendFromMachineLearnPai2-1.control
